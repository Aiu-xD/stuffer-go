...
# APM 0.5.0-test-4 - Research Delegation Guide
...
2. Open new Ad-Hoc agent chat session & initialize it with .windsurf/workflows/Ad_Hoc_Agent_Initiation_Prompt.md
